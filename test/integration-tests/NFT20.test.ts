...
const ALPHABETTIES_ADDRESS = '0x6d05064fe99e40f1c3464e7310a23ffaded56e20'
...
describe('NFT20', () => {
  ...
  describe('Buy 3 alphabetties from NFT20', () => {
    ...
    it('purchases token ids 129, 193, 278 of Alphabetties', async () => {
      ...
      await expect((await alphabetties.connect(alice).ownerOf(129)).toLowerCase()).to.eq(ALICE_ADDRESS)
      await expect((await alphabetties.connect(alice).ownerOf(193)).toLowerCase()).to.eq(ALICE_ADDRESS)
