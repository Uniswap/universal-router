...
export const seaportV3Orders = JSON.parse(
  fs.readFileSync('test/integration-tests/shared/orders/SeaportV3.json', { encoding: 'utf8' })
)
export const seaportInterface = new ethers.utils.Interface(SEAPORT_ABI)
export const seaportV3Interface = new ethers.utils.Interface(SEAPORT_V3_ABI)
